...
import com.swifttech.sr.ps.schema.mapper.ProductAndServiceClassificationMapper;
import com.swifttech.sr.ps.schema.model.request.ProductAndServiceClassificationCreateUpdateRequest;
import com.swifttech.sr.ps.schema.model.response.ProductAndServiceClassificationResponse;
import com.swifttech.sr.ps.schema.repository.ProductAndServiceClassificationRepository;
...
import com.swifttech.sr.ps.schema.repository.ValueComponentRepository;
...
public class ProductAndServiceClassificationServiceImpl implements ProductAndServiceClassificationService {
    ...
    @Override
    public GlobalResponse findProductAndServiceClassificationPaginatedData(PaginationRequest request) throws GlobalException {
        Page<ProductAndServiceClassificationEntity> page = repository.findAll(Helper.getPageable(request));
