...
public class CurrencyClassificationSpecification {

    private CurrencyClassificationSpecification() {}

    public static Specification<CurrencyClassificationEntity> filterBy(CurrencyClassificationDataRequest request) {
