...
public class ValueComponentSpecification {

    private ValueComponentSpecification() {}

    public static Specification<ValueComponentEntity> filterBy(ValueComponentDataRequest request) {
