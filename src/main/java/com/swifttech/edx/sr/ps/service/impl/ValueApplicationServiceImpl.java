...
import com.swifttech.edx.sr.ps.mapper.ValueApplicationMapper;
...
import com.swifttech.edx.sr.ps.repository.ValueApplicationRepository;
import com.swifttech.edx.sr.ps.service.ValueApplicationService;
import com.swifttech.edx.sr.ps.service.specification.ValueApplicationSpecification;
...
public class ValueApplicationServiceImpl implements ValueApplicationService {
    ...
    @Override
    public GlobalResponse findValueApplicationPaginatedData(ValueApplicationDataRequest request) throws GlobalException {
        Specification<ValueApplicationEntity> spec = ValueApplicationSpecification.filterBy(request);
        Page<ValueApplicationEntity> page = repository.findAll(spec, Helper.getPageable(request));
