...
public class ValueMovementSpecification {

    private ValueMovementSpecification() {}

    public static Specification<ValueMovementEntity> filterBy(ValueMovementDataRequest request) {
